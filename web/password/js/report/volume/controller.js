...
techPayControllers.controller('ReportVolumeCtrl',  function($scope, $location, $cookieStore, report) {
    var seriesVolume = [];
    var chart;
    var seriesVisa;
    ...
    function load()
    {
        ...
        report.volume(authToken, '2014-01-03','2015-01-05').success(success).error(error);
    ...
    function createMonitorChart() {
        $(document).ready(function () {
            ...
            chart  = $('#transactionVolume').highcharts('StockChart', {
                chart: {
                ...
                title: {
                    text: 'Volume de transações aprovadas'
                },
                xAxis: {
                    type: 'datetime',
                ...
                tooltip: {
                    formatter: function () {
                        return '<b>' + seriesVolume.name + '</b><br/>' +
